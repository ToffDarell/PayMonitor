...
<div class="d-flex justify-content-between align-items-center mb-4">
    <h5 class="mb-0 fw-bold">New Plan</h5>
        ...
        <form action="{{ route('superadmin.plans.store') }}" method="POST">
            ...
            <div class="row g-3 mb-3">
                <div class="col-6">
                    ...
                    <input type="number" name="max_branches" value="{{ old('max_branches', 0) }}" min="0" class="form-control @error('max_branches') is-invalid @enderror" required>
                    @error('max_branches')<div class="invalid-feedback">{{ $message }}</div>@enderror
                </div>
                <div class="col-6">
                    <label class="form-label fw-semibold">Max Users</label>
                    <small class="d-block text-muted mb-1">0 = Unlimited</small>
                    <input type="number" name="max_users" value="{{ old('max_users', 0) }}" min="0" class="form-control @error('max_users') is-invalid @enderror" required>
