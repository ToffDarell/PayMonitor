    ...
    <div class="card-body">
        <form method="GET" action="{{ route('loans.index', $tenantParameter) }}" class="row g-3 align-items-end">
            <div class="col-md-3">
                ...
                <select name="branch" id="branch" class="form-select" x-on:change="$el.form.requestSubmit()">
            ...
            <div class="col-md-3">
                ...
                <select name="status" id="status" class="form-select" x-on:change="$el.form.requestSubmit()">
            ...
            <div class="col-md-3">
                ...
                <select name="loan_type" id="loan_type" class="form-select" x-on:change="$el.form.requestSubmit()">
