...
@endphp
    ...
    <p>
        This letter serves as a formal demand for the immediate payment of your outstanding loan obligation
        with {{ $cooperativeName }}.
    </p>
    ...
    <p>
        You are hereby demanded to pay the total amount of <strong>&#8369;{{ number_format((float) $totalDue, 2) }}</strong>
        within fifteen (15) days from receipt of this letter.
    </p>

    <p>Failure to comply will compel us to take legal action without further notice.</p>
    ...
    <div style="margin-top:56px; border-top:1px solid #cbd5e1; padding-top:12px; text-align:center; font-size:11px; color:#475569;">
        This is an official document of {{ $cooperativeName }}.<br>
        Generated by PayMonitor on {{ now()->format('F d, Y') }}.<br>
        DS · {{ $verificationCode }}
    </div>
</body>
</html>
